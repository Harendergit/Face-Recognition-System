    ...
    #   import pymysql
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='1234', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/lenovo/Downloads/Face-Recognition-Attendance-System-main (1)/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/lenovo/Downloads/Face-Recognition-Attendance-System-main (1)\Attendance/Manually Attendance/-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/lenovo/Downloads/Face-Recognition-Attendance-System-main (1)/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/lenovo/Downloads/Face-Recognition-Attendance-System-main (1)\Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'arun':
            if password == 'arun123':
                ...
                cs = 'C:/Users/lenovo/Downloads/Face-Recognition-Attendance-System-main (1)/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
